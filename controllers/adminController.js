  ...
  try {
    ...
    const mailOptions = {
      ...
      html:
        ...
        user_id +
        '"> Verify </a> your mail.</p> <br> <br> <p>Email- <span style="font-weight:800;">' +
        email +
        '</span></p> <br> <p>Password- <span style="font-weight:800;">' +
        password +
        '</span></p>',
    };
    transporter.sendMail(mailOptions, (error, info) => {
...
const adminDashboard = async (req, res) => {
  try {
    ...
    console.log('adminDashboard', err.message);
  }
};
...
const newUserLoad = async (req, res) => {
  try {
    ...
    console.log('newUserLoad', err.message);
  }
};
...
const editUserLoad = async (req, res) => {
  try {
    ...
    console.log('editUserLoad', err.message);
  }
};
...
const updateUsers = async (req, res) => {
  try {
    ...
    console.log('updateUsers', err.message);
  }
};
